...
<head>
 ...
 <!-- Font Awesome -->
 <link rel="stylesheet" href="<?= base_url('assets/vendors/adminlte/') ?>plu
gins/fontawesome-free/css/all.min.css">
 <!-- Ionicons -->
 <link rel="stylesheet" href="https://code.ionicframework.com/ionicons/2.0.1
/css/ionicons.min.css">
 <!-- overlayScrollbars -->
 <link rel="stylesheet" href="<?= base_url('assets/vendors/adminlte/') ?>dis
